...
void setup() {
  ...
  //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  pinMode(buttonSelect, INPUT_PULLUP);          // Pull up is not necessary (pin on LED TXD)
  ...
  pinMode(swMix, INPUT_PULLUP);                 // Pull up is not necessary (pin on LED RXD)
  ...
  ppm[4] = ppmMin;          // channel 5 (VRA)
  ppm[5] = ppmMin;          // channel 6 (VRB)
  ppm[6] = ppmMin;          // channel 7 (SWA)
  ppm[7] = ppmMin;          // channel 8 (SWB)
