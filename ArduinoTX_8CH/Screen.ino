...
//    u8g2.drawVLine(65, 14, 64);
    u8g2.drawLine(65, 14, 65, 42);
    u8g2.drawLine(64, 48, 64, 64);
    u8g2.drawLine(66, 48, 66, 64);
...
//    if (bitRead(servoReverse, 4) == 1) {
      if (read_adc(6) < 500) {
      u8g2.drawRFrame(8, 43, 11, 20, 3);               // Draw SWA box
      u8g2.drawDisc(13, 48, 3, U8G2_DRAW_ALL);          // Draw SWA round point
      }
      else {
      u8g2.drawRFrame(8, 43, 11, 20, 3);               // Draw SWA box
      u8g2.drawDisc(13, 57, 3, U8G2_DRAW_ALL);          // Draw SWA round point
      }
...
//    if (bitRead(servoReverse, 5) == 1) {
      if (digitalRead(swB) == 0) {
      u8g2.drawRFrame(37, 43, 11, 20, 3);              // Draw SWB box
      u8g2.drawDisc(42, 48, 3, U8G2_DRAW_ALL);         // Draw SWB round point
      }
      else {
      u8g2.drawRFrame(37, 43, 11, 20, 3);              // Draw SWB box
      u8g2.drawDisc(42, 57, 3, U8G2_DRAW_ALL);         // Draw SWB round point
      }
